...
import selectedLike from './assets/icon-heart-on.svg'
...
function ProductListItem({productName, price, thumbnailImg}){
  ...
  const BtnLike = styled.button`
    ...
    height: 22px;
    border: none;
    background: url(${btnLike===false?like:selectedLike}) no-repeat center / contain;
  `
  return (
    <ItemProductList>
      <ImgProduct 
      ...
      <ContainerSpaceBetween>
        ...
        <BtnLike onClick={toggleBtn}></BtnLike>
      </ContainerSpaceBetween>
